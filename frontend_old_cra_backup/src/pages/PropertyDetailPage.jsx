              ...
              <div className="flex flex-wrap gap-6 py-6 border-y border-stone-200">
                ...
                {property.bathrooms > 0 && (
                  <div className="flex items-center gap-3">
                    ...
                    <div><p className="text-2xl font-semibold text-slate-900">{property.bathrooms}</p><p className="text-sm text-stone-500">Banos</p></div>
                  </div>
                )}
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 bg-stone-100 flex items-center justify-center"><Square className="h-6 w-6 text-slate-900" /></div>
                  <div><p className="text-2xl font-semibold text-slate-900">{property.area}</p><p className="text-sm text-stone-500">m2</p></div>
                </div>
              </div>
