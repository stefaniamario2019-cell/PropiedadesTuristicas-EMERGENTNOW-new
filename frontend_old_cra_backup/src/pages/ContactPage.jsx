            ...
            <div>
              ...
              <div className="bg-green-50 p-6 border border-green-100">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 px-6 py-3 bg-green-500 hover:bg-green-600 text-white font-semibold transition-all"
                >
              ...
              {/* Map Placeholder */}
              <div className="mt-8">
                <div className="map-container bg-stone-200 flex items-center justify-center h-[250px]">
                  <div className="text-center text-stone-500">
                    <MapPin className="h-12 w-12 mx-auto mb-2" />
                    <p className="font-medium">{agency?.address || 'Santo Domingo, República Dominicana'}</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="bg-white p-8 md:p-10 shadow-lg border border-stone-100">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <Button
                    ...
                    disabled={submitting}
                    className="w-full py-4 text-white font-semibold text-lg transition-all hover:shadow-lg"
                    style={{ backgroundColor: '#C5A059' }}
                  >
