...
function App() {
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        <Route path="/admin" element={user ? <Navigate to="/admin/dashboard" replace /> : <LoginPage onLogin={handleLogin} />} />
        <Route path="/admin/dashboard" element={user ? <AdminDashboard user={user} onLogout={handleLogout} /> : <Navigate to="/admin" replace />} />
